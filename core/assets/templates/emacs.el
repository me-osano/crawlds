;;; crawlds-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme crawlds "Theme using Template variables with quality of life improvements.")
...
(provide-theme 'crawlds)
;;; crawlds-theme.el ends here
