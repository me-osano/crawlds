//! Vibrant scheme implementation
//!
//! Prioritizes the most saturated colors regardless of area coverage.
...
impl SchemeVibrant {
    pub fn new(source_hue: f32, source_chroma: f32) -> Self {
        ...
        let sec_chroma = if source_chroma > 36.0 {
            source_chroma
        } else {
            36.0
        };
        let ter_chroma = if source_chroma > 24.0 {
            source_chroma
        } else {
            24.0
        };
        ...
        Self {
            ...
            tertiary_palette: TonalPalette::new((source_hue + 60.0).rem_euclid(360.0), ter_chroma),
