//! Muted scheme implementation
//!
//! Low saturation scheme - preserves hue but caps saturation low.
//! Ideal for monochrome or monotonal wallpapers.

use crate::dynamic::hct::TonalPalette;
use crate::dynamic::scheme::tones::{ToneValues, MUTED_DARK_TONES, MUTED_LIGHT_TONES};
use crate::dynamic::scheme::{Scheme, SchemeColors};

pub struct SchemeMuted {
...
impl SchemeMuted {
    pub fn new(source_hue: f32) -> Self {
        Self {
            primary_palette: TonalPalette::new(source_hue, 35.0),
            secondary_palette: TonalPalette::new(source_hue, 24.0),
            tertiary_palette: TonalPalette::new(source_hue, 20.0),
            neutral_palette: TonalPalette::new(source_hue, 6.0),
...
impl Scheme for SchemeMuted {
    fn get_dark(&self) -> SchemeColors {
        self.generate(&MUTED_DARK_TONES)
    }

    fn get_light(&self) -> SchemeColors {
        self.generate(&MUTED_LIGHT_TONES)
    }
}
