...
Singleton {
  ...
  property string historyFile: Quickshell.env("CRAWLDS_NOTIF_HISTORY_FILE") || (Settings.cacheDir + "notifications.json")

  // State
  property real lastSeenTs: 0
  // Volatile property that doesn't persist to settings
