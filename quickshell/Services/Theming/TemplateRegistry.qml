...
Singleton {
  ...
  // Dynamically resolved VSCode extension theme paths (all matching crawlds extensions)
  ...
  readonly property var terminals: [
    {
      ...
      "outputPath": "~/.config/foot/themes/crawlds",
    ...
    },
    {
      ...
      "outputPath": "~/.config/ghostty/themes/crawlds",
    ...
    },
    {
      ...
      "outputPath": "~/.config/kitty/themes/crawlds.conf",
    ...
    },
    {
      ...
      "outputPath": "~/.config/alacritty/themes/crawlds.toml",
    ...
    },
    {
      ...
      "outputPath": "~/.config/wezterm/colors/CrawlDS.toml",
  ...
  readonly property var applications: [
    {
      ...
      "outputs": [
        {
          "path": "~/.config/gtk-3.0/crawlds.css",
          "input": "gtk3.css"
        },
        {
          "path": "~/.config/gtk-4.0/crawlds.css",
          "input": "gtk4.css"
        }
      ],
    ...
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.config/qt5ct/colors/crawlds.conf"
        },
        {
          "path": "~/.config/qt6ct/colors/crawlds.conf"
        }
      ]
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.local/share/color-schemes/crawlds.colors"
        }
      ],
      "postProcess": () => "if command -v plasma-apply-colorscheme >/dev/null 2>&1; then plasma-apply-colorscheme BreezeDark; sleep 0.5; plasma-apply-colorscheme crawlds; fi"
    },
    {
      "id": "fuzzel",
      "name": "Fuzzel",
      ...
      "outputs": [
        {
          "path": "~/.config/fuzzel/themes/crawlds"
        }
      ],
    ...
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.local/share/vicinae/themes/crawlds.toml"
        }
      ],
      "postProcess": () => `cp --update=none ${Quickshell.shellDir}/Assets/crawlds.svg ~/.local/share/vicinae/themes/crawlds.svg && ${templateApplyScript} vicinae`
    },
    {
      "id": "walker",
      "name": "Walker",
      ...
      "outputs": [
        {
          "path": "~/.config/walker/themes/crawlds/style.css"
        }
      ],
    ...
    },
    {
      ...
      "clients": [
        {
          "name": "code",
          "path": "~/.vscode/extensions/crawlds.crawldstheme-0.0.5/themes/CrawlDSTheme-color-theme.json"
        },
        {
          "name": "codium",
          "path": "~/.vscode-oss/extensions/crawlds.crawldstheme-0.0.5-universal/themes/CrawlDSTheme-color-theme.json"
        }
      ]
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.config/zed/themes/crawlds.json"
        }
      ],
    ...
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.config/helix/themes/crawlds.toml"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.config/telegram-desktop/themes/crawlds.tdesktop-theme"
        }
      ]
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.cache/crawlds/zen-browser/zen-userChrome.css"
        },
        {
          "path": "~/.cache/crawlds/zen-browser/zen-userContent.css",
          "input": "zen-browser/zen-userContent.css"
        }
      ],
      "postProcess": ()
                     => "sh -c 'CSS_CHROME=\"$HOME/.cache/crawlds/zen-browser/zen-userChrome.css\"; CSS_CONTENT=\"$HOME/.cache/crawlds/zen-browser/zen-userContent.css\"; LINE_CHROME=\"@import \\\"$CSS_CHROME\\\";\"; LINE_CONTENT=\"@import \\\"$CSS_CONTENT\\\";\"; find \"$HOME/.config/zen\" \"$HOME/.zen\" -mindepth 2 -maxdepth 2 -type d -name chrome -print0 2>/dev/null | while IFS= read -r -d \"\" dir; do USER_CHROME=\"$dir/userChrome.css\"; USER_CONTENT=\"$dir/userContent.css\"; mkdir -p \"$dir\"; touch \"$USER_CHROME\" \"$USER_CONTENT\"; sed -i \"/zen-browser\\/zen-userChrome\\.css/d\" \"$USER_CHROME\"; sed -i \"/zen-browser\\/zen-userContent\\.css/d\" \"$USER_CONTENT\"; if ! grep -Fq \"$LINE_CHROME\" \"$USER_CHROME\"; then printf \"%s\\n\" \"$LINE_CHROME\" >> \"$USER_CHROME\"; fi; if ! grep -Fq \"$LINE_CONTENT\" \"$USER_CONTENT\"; then printf \"%s\\n\" \"$LINE_CONTENT\" >> \"$USER_CONTENT\"; fi; done'"
    },
    {
      "id": "cava",
      "name": "Cava",
      ...
      "outputs": [
        {
          "path": "~/.config/cava/themes/crawlds"
        }
      ],
    ...
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.config/yazi/flavors/crawlds.yazi/flavor.toml"
        }
      ],
    ...
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.config/hypr/crawlds/crawlds-colors.conf"
        }
      ],
    ...
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.config/mango/crawlds.conf"
        }
      ],
    ...
    },
    {
      ...
      "outputs": [
        {
          "path": "~/.config/btop/themes/crawlds.theme"
        }
      ],
    ...
    if (discordApp && discordApp.clients) {
      discordApp.clients.forEach(client => {
                                   clients.push({
                                                  ...
                                                  "themePath": `${client.path}/themes/crawlds.theme.css`
                                                });
                                 });
    }
    return clients;
  ...
  function buildUserTemplatesToml() {
    ...
    lines.push("# input_path = \"~/.config/crawlds/templates/myapp.css\"");
    ...
    lines.push("#input_path = \"" + Quickshell.shellDir + "/Assets/Templates/crawlds.json\"");
