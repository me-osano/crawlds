...
Singleton {
  ...
  readonly property string crawldsDefaultWallpaper: Quickshell.shellDir + "/Assets/Wallpaper/crawlds.png"
  property string defaultWallpaper: crawldsDefaultWallpaper
  ...
  function translateModels() {
    // Populate fillModeModel with English names
  ...
  FileView {
    ...
    adapter: JsonAdapter {
      ...
      property string defaultWallpaper: root.crawldsDefaultWallpaper
      property var usedRandomWallpapers: ({})
    }
    ...
    onLoaded: {
      ...
      // Load default wallpaper from cache if it exists, otherwise use CrawlDS default
      if (wallpaperCacheAdapter.defaultWallpaper && wallpaperCacheAdapter.defaultWallpaper !== "") {
        ...
        root.defaultWallpaper = root.crawldsDefaultWallpaper;
        Logger.d("Wallpaper", "Using CrawlDS default wallpaper");
      }
