...
CrawlDS Shell is made possible by the incredible work of many open-source projects and contributors.

## Design & Branding

- **MrDowntempo** - Creator of the CrawlDS Owl and moon logo
- **[SaberJ2X](https://www.reddit.com/user/SaberJ64/)** - Creator of Talia, the CrawlDS mascot

## Core Framework

- **[Quickshell](https://github.com/outfoxxed/quickshell)** - The Qt/QML-based Wayland shell framework that powers CrawlDS
...
- All the contributors and users who have helped make CrawlDS better

## License
CrawlDS Shell is licensed under the MIT License. See [LICENSE](LICENSE) for details.
