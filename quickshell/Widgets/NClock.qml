...
import Quickshell
import "../Common/Helpers/ColorsConvert.js" as ColorsConvert
import qs.Common
import qs.Widgets
...
Item {
  ...
  component NClockDigital: Item {
    ...
    ColumnLayout {
      ...
      NText {
        text: {
          var t = Settings.data.location.use12hourFormat ? Qt.locale("en").toString(now, "hh AP") : Qt.locale("en").toString(now, "HH");
          return t.split(" ")[0];
        }
