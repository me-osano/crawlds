...
/*
CrawlDS is not strictly a Material Design project, it supports both some predefined
...
Singleton {
  ...
  // --------------------------------
  // Default colors: CrawlDS (default) dark — must match Assets/ColorScheme/CrawlDS-default
  QtObject {
    id: defaultColors
