...
Popup {
  ...
  TextMetrics {
    ...
    text: "Managed via CRAWLDS_WALLHAVEN_API_KEY environment variable."
  ...
  contentItem: ColumnLayout {
    ...
    ColumnLayout {
      ...
      NTextInput {
        ...
        placeholderText: WallhavenService.apiKeyManagedByEnv ? "Managed via CRAWLDS_WALLHAVEN_API_KEY environment variable." : "Enter your Wallhaven API Key"
      ...
      NText {
        text: "An API key is required to access NSFW content."
