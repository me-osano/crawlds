...
/**
* SmartPanel for use within Screen
*/
Item {
  id: root

  // Screen property provided by Screen
  ...
  // These are called from Screen's centralized shortcuts
  ...
  function closeImmediately() {
    ...
    // Signal immediate close so Screen can skip dimmer animation
