...
Variants {
  ...
  delegate: Loader {
    ...
    sourceComponent: PanelWindow {
      ...
      WlrLayershell.namespace: "crawlds-wallpaper-" + (screen?.name || "unknown")
      ...
      Component {
        ...
        ShaderEffect {
          ...
          fragmentShader: Qt.resolvedUrl(Quickshell.shellDir + "/Common/Shaders/qsb/wp_fade.frag.qsb")
        }
      }
      ...
      Component {
        ...
        ShaderEffect {
          ...
          fragmentShader: Qt.resolvedUrl(Quickshell.shellDir + "/Common/Shaders/qsb/wp_wipe.frag.qsb")
        }
      }
      ...
      Component {
        ...
        ShaderEffect {
          ...
          fragmentShader: Qt.resolvedUrl(Quickshell.shellDir + "/Common/Shaders/qsb/wp_disc.frag.qsb")
        }
      }
      ...
      Component {
        ...
        ShaderEffect {
          ...
          fragmentShader: Qt.resolvedUrl(Quickshell.shellDir + "/Common/Shaders/qsb/wp_stripes.frag.qsb")
        }
      }
      ...
      Component {
        ...
        ShaderEffect {
          ...
          fragmentShader: Qt.resolvedUrl(Quickshell.shellDir + "/Common/Shaders/qsb/wp_pixelate.frag.qsb")
        }
      }
      ...
      Component {
        ...
        ShaderEffect {
          ...
          fragmentShader: Qt.resolvedUrl(Quickshell.shellDir + "/Common/Shaders/qsb/wp_honeycomb.frag.qsb")
        }
      }
